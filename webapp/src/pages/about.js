...
function IndexPage() {
  return (
    <Layout>
      <div className="mx-10 lg:mx-20 flex flex-col justify-between min-h-screen" style={{ paddingTop: "89px" }}>
        <div className="mt-10 w-7/12 smd:w-8/12">
          ...
          <div className="text-customGray lg:flex items-center text-lg mt-5 w-10/12">
            <Link to="/contact" className="items-center mr-5 mb-5 lg:mb-0"><button className="secondery flex items-center">
        ...
        <div className="absolute min-h-full" style={{ maxWidth:"1440px"}}>
          <div className="w-7/12 float-right flex flex-col">
            <img className="object-right-top" style={{ paddingBottom: "-30px" }} src={images.IMAGE_DECORATION}></img>
            <div className="min-h-screen border bg-white p-5 text-black text-lg w-full">
